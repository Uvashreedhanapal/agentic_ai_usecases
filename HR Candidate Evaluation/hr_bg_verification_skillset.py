...
from verification import mock_verify_identity, provider_verify_identity
...
# Check if real verification should be used
VERIFICATION_ENABLED = os.getenv("VERIFICATION_API_URL") and os.getenv("VERIFICATION_API_KEY")
...
"""
    ...
    # Background Verification (Mock or Provider)
    try:
        if VERIFICATION_ENABLED:
            bg_json = provider_verify_identity(candidate_name, email, None)
        else:
            bg_json = mock_verify_identity(candidate_name, email, None)
